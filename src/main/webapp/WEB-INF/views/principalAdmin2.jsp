	...
	<div class="">
		...
		<nav class="navbar navbar-expand-md navbar-light fixed-top bg-light">
			...
			<div class="input-group input-group-sm mb-2 mr-sm-2 mb-sm-0">
				...
				<a href="principalAdmin" role="button" class="btn btn-outline-success btn-sm derecha">Usuarios</a>
				<a href="principalAdmin" role="button" class="btn btn-outline-success btn-sm derecha" style="margin-left: 1%">Conceptos</a>
				<a href="principalAdmin" role="button" class="btn btn-outline-success btn-sm derecha" style="margin-left: 1%">Nominas</a>
				<a href="principalAdmin" role="button" class="btn btn-outline-success btn-sm derecha" style="margin-left: 1%">Nominas</a>
				<a href="principalAdmin" role="button" class="btn btn-outline-success btn-sm derecha" style="margin-left: 1%">Nominas</a>
				<a href="principalAdmin" role="button" class="btn btn-outline-success btn-sm derecha" style="margin-left: 1%">Nominas</a>
				<a href="principalAdmin" role="button" class="btn btn-outline-success btn-sm derecha" style="margin-left: 1%">Nominas</a>
